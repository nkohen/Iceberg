...
def test_key_sort_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'key_sort_vectors.json')) as f:
...
def test_key_agg_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'key_agg_vectors.json')) as f:
        test_data = json.load(f)
...
def test_nonce_gen_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'nonce_gen_vectors.json')) as f:
        test_data = json.load(f)
...
def test_nonce_agg_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'nonce_agg_vectors.json')) as f:
        test_data = json.load(f)
...
def test_sign_verify_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'sign_verify_vectors.json')) as f:
        test_data = json.load(f)
...
def test_tweak_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'tweak_vectors.json')) as f:
        test_data = json.load(f)
...
def test_det_sign_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'det_sign_vectors.json')) as f:
        test_data = json.load(f)
...
def test_sig_agg_vectors() -> None:
    with open(os.path.join(sys.path[0], 'musig_vectors', 'sig_agg_vectors.json')) as f:
        test_data = json.load(f)
